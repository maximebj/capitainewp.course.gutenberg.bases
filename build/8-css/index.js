...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block.json */ "./src/8-css/block.json");
/**
...
function save(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "first-line"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "#"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "span",
    className: "number",
    value: props.attributes.number
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"capitainewp/css","version":"1.0","title":"8. CSS","icon":"admin-appearance","category":"text","description":"Un bloc avec du joli CSS","supports":{"html":false},"attributes":{"number":{"type":"string","source":"html","selector":".number"},"title":{"type":"string","source":"html","selector":".title"}},"textdomain":"capitainewp-gut-bases","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["8-css/style-index"], () => (__webpack_require__("./src/8-css/index.js")))
